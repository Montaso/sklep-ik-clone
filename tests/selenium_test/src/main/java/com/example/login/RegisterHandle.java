...
public class RegisterHandle {
    ...
    private final String registrationLink = "https://localhost:8080/logowanie?create_account=1";
    ...
    private final String email = "marcin-siemaszko12@essa.com";
    ...
    public RegisterHandle(WebDriver driver) {
        this.driver = driver;
    }
